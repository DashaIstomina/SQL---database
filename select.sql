...
Увидеть только последние 5 поступивших заявок, чтобы быстро оценить текущую нагрузку.  
...
gроанализировать заявки на кредиты от 300 000 до 700 000 рублей включительно.  
Решение:   
SELECT   
    application_id,   
    client_id,   
